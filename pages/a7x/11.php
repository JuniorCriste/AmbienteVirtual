...
<body>
<div id="nomeaula">Ferramentas Gratuitas Para Produção!</div>
<div id="g1">
<div id="videoaula">

<iframe id="youtubehere" frameborder="0" allowfullscreen="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" title="Interface" width="720" height="405" src="https://www.youtube-nocookie.com/embed/PtGcxY5tDsA?modestbranding=1&amp;autoplay=false&amp;rel=0&amp;iv_load_policy=3&amp;enablejsapi=1&amp;"></iframe>
...
No mercado existem muitas ferramentas para produção, mas em maioria essas são de preço elevado, por outra parte existem algumas alternativas incríveis!
</div>
</div>
</body>
</html>
